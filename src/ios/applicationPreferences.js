...
ApplicationPreferences.prototype.get = function(key, successFn, errorFn) {
	cordova.exec(successFn, errorFn, 'applicationPreferences', 'getSetting', [key]);
};
ApplicationPreferences.prototype.set = function(key,value, successFn, errorFn) {
	cordova.exec(successFn, errorFn, 'applicationPreferences', 'setSetting', [key,value]);
};
ApplicationPreferences.prototype.clear = function(key, successFn, errorFn) {
    cordova.exec(successFn, errorFn, 'applicationPreferences', 'clearSetting', [key]);
};
